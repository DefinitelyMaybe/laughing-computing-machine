...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-b239bda2.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-b239bda2.js", assets + "/_app/chunks/vendor-836cc791.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-1e23b955.js", "css": ["assets/pages/__layout.svelte-1fda6867.css"], "js": ["pages/__layout.svelte-1e23b955.js", "chunks/vendor-836cc791.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-477e24cb.js", "css": [], "js": ["error.svelte-477e24cb.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-14a2fee8.js", "css": ["assets/pages/index.svelte-b6f83df6.css"], "js": ["pages/index.svelte-14a2fee8.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-f3eac05a.js", "css": ["assets/pages/about.svelte-bf4528fa.css"], "js": ["pages/about.svelte-f3eac05a.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-17692b2d.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-17692b2d.js", "chunks/vendor-836cc791.js"], "styles": [] } };
...
function render(request, {
  ...
  return respond({ ...request, host: host2 }, options, { prerender: prerender2 });
}
...
function createServer({ render: render2 }) {
  const prerendered_handler = existsSync(paths.prerendered) ? serveStatic(paths.prerendered, {
    etag: true,
    maxAge: 0
  }) : noop_handler;
  const assets_handler = existsSync(paths.assets) ? serveStatic(paths.assets, {
    maxAge: 31536e3,
    immutable: true
  }) : noop_handler;
  const server = opine().use(assets_handler, prerendered_handler, async (req, res) => {
...
var instance = createServer({ render }).listen(addr, (err) => {
  if (err) {
